...
public class BatterieTestsDevoirMaison {
    ...
    public void testVilleDesservieCovoiturage() throws Exception {
        ...
        Covoiturage c1=new Covoiturage(
                new ArrayList<>(Arrays.asList(new Voiture[]{v1,v2,v3})),
    ...
    public void testGetVilles() throws Exception {
        ...
        Covoiturage c2=new Covoiturage(
                new ArrayList<>(Arrays.asList(new Voiture[]{v1})),
    ...
    public void testEstPossible() throws Exception {
        ...
        c1=new Covoiturage(
                new ArrayList<>(Arrays.asList(new Voiture[]{v4,v1})),
    ...
    public void testGetIdentifiant() throws Exception {
        ...
        assertEquals(true, c1.getIdentifiant("Jules")==2 ||  c1.getIdentifiant("Jules")==3,"Problème getIdentifiant: devait renvoyer 2 ou 3");
